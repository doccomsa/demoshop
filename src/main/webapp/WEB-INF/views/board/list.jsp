        	...
        	<div class="col-md-12">
                ...
                <div>
                  ...
                  <c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="num">
                    <li class="${pageMaker.cri.pageNum == num ? 'active': ''}"><a class="page-link" href="${num }">${num }</a></li>
                  </c:forEach>
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
    ...
    <script>
      ...
      $(document).ready(function(){
        ...
        // [이전] 1 2 3 4 5 [다음]   <a href="1"></a> 링크기능이 동작되면 안된다.
        $("li a.page-link").on("click", function(e){
          e.preventDefault(); // <a>태그의 링크기능을 제거.

          let num = $(this).attr("href");
          // <form id="actionForm">안에서 "input[name='pageNum']" 선택자에 해당하는 태그를 참조
          actionForm.find("input[name='pageNum']").val(num); //  <input type="hidden" name="pageNum" value="">
          actionForm.attr("action", "/board/list"); // <form action="/board/list">
        ...
        $("a.move").on("click", function(e){
          e.preventDefault(); //링크기능 비활성화.
          let bno = $(this).attr("href");
          console.log("글번호: " + bno);

          
          
          // 브라우저에서 이전버튼 클릭시 동작상태 체크할 것
          actionForm.find("input[name='bno']").remove();
          
          
          //form태그에 태그를 자식으로 추가할 때 사용.
